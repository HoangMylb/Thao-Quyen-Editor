...
export default function AdminPostsPage() {
  const { posts, deletePost, postsLoading } = useSiteData();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <p className="text-xs text-slate-500">Viết bài mới, quản lý bản nháp và biên tập các nội dung chia sẻ kinh nghiệm.</p>
        </div>
        <Link
      ...
      <div className="border border-card-border bg-white rounded-2xl overflow-hidden shadow-sm">
        {postsLoading ? (
          <div className="p-6">
            <SectionLoading title="Đang tải danh sách bài viết..." lines={5} />
          </div>
        ) : (
